...
MODFLOW-NWT version 1.0.5 is packaged for personal computers using one of the 
...
Included in directory MODFLOW-NWT_1.0.5\doc is the MODFLOW-NWT documentation 
...
directory, the directory containing the executables (MODFLOW-NWT_1.0.5\bin)
...
in the MODFLOW-NWT_1.0.5\bin directory can be copied into a directory already
...
Add the following line to the AUTOEXEC.BAT file:
  ...
  PATH=%PATH%;C:\WRDAPP\MODFLOW-NWT_1.0.5\bin
...
"PATH" in the Variable field and enter
   ...
   %PATH%;C:\WRDAPP\MODFLOW-NWT_1.0.5\bin
...
";C:\WRDAPP\MODFLOW-NWT_1.0.5\bin" to its definition in the Value field, and click
...
";C:\WRDAPP\MODFLOW-NWT_1.0.5\bin" to the end of the Variable Value (ensure that
...
A 32 bit and a 64 bit executable are provided in the MODFLOW-NWT_1.0.5\bin  
...
After the executable files in the MODFLOW-NWT_1.0.5\bin directory are installed in
...
The executable files provided in MODFLOW-NWT_1.0.5\bin were created using the Intel  
Visual Fortran 12.1 compiler. Although executable versions of the program are  
provided, the source code also is provided in the MODFLOW-NWT_1.0.5\src directory so 
